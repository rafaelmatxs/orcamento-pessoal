...
function cadastrarEmpresa() {
    ...
    if(despesa.validarDados()) {
        ...
        document.getElementById('des_modal').innerHTML = 'Despesa cadastrada com sucesso'
        document.getElementById('btn_modal').innerHTML = 'Voltar'
        document.getElementById('txt_modal').className = 'modal-header text-success'
        ...
        document.getElementById('titulo_modal').innerHTML = 'Erro: Registro inválido'
        document.getElementById('des_modal').innerHTML = 'Preencha todos os campos para continuar!'
        document.getElementById('btn_modal').innerHTML  = 'Voltar e corrigir'
        document.getElementById('txt_modal').className = 'modal-header text-danger'
